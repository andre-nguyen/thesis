...
\centerline{
	...
	\centering
    \caption{
    Left: the Husky robot used in our experiments with the robotic arm, depth sensor and laser range scanner.
    All other sensors seen are not used.
    Right: the indoor structure being inspected.}
    \label{fig:husky_exp}
\end{figure}
