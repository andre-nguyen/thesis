...
Suivant la définition posée par \citep{Yamauchi1997}, un frontier est une cellule adjacente à une cellule de l'espace inconnu. Grâce à notre OctoMap il est donc possible de calculer l'ensemble de tous les voxels frontier. 
