...
\begin{figure}[!h]
  \centering
  \subfloat[]{
  	\includegraphics[width=0.3\linewidth]{images/frustrum}
    \label{subfig:frustrum}
  }
  \hfil
  \subfloat[]{
  	\includegraphics[width=0.3\linewidth]{images/frontier_candidates}
  	\label{subfig:ugv_frontier}
  }
  \hfil
  \subfloat[]{
  	\includegraphics[width=0.3\linewidth]{images/frontier_voxels}
...
\begin{figure}[p]
  ...
  \subfloat[Modèle: Petit $\Gamma$, Profondeur Max.: $4.5m$]{
      \includegraphics[width=0.3\linewidth]{images/SmallGamma_Husky_4_5}
  	\label{subfig:small gamma husky 4.5}
  }
  \hfil
  \subfloat[Modèle: Petit $\Gamma$, Profondeur Max.: $12m$]{
  	\includegraphics[width=0.3\linewidth]{images/SmallGamma_Husky_12}
  	\label{subfig:small gamma husky 12}
  }
  \hfil
  \subfloat[Modèle: Grand $\Gamma$, Profondeur Max.: $4.5m$]{
  	\includegraphics[width=0.3\linewidth]{images/LargeGamma_Husky_4_5}
  	\label{subfig:large gamma husky 4.5}
  }
  \hfil
  \subfloat[Modèle: Grand {\large a}, Profondeur Max.: $4.5m$]{
  	\includegraphics[width=0.3\linewidth]{images/LargeA_Husky_4_5}
