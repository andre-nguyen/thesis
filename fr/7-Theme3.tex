...
Une fois les contours trouvés, nous pouvons les utiliser pour détecter des segments de droite dans l'image. Plusieurs méthodes de détection de segments existent, nous comparons trois méthodes dont la bien connue transformée de Hough probabiliste, Edge Drawling lines (EDLines) et le Line Segment Detector (LSD).
